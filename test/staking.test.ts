...
describe('Staking Tests', () => {
  describe('Query', () => {
    ...
    test('query delegations of a delegator', async () => {
      await BaseTest.getClient()
        .staking.queryDelegations({
          delegator_addr:'kynno16yky9s6tjmv3kvvrxtnnrcn7x42ngs5wzjcywt'
        })
        .then(res => {
          console.log(res);
        })
    ...
    test('queries validator info for given delegator validator', async () => {
      await BaseTest.getClient()
        .staking.queryDelegatorValidator(
          {
            delegator_addr:'kynno16yky9s6tjmv3kvvrxtnnrcn7x42ngs5wzjcywt',
            validator_addr:'kynnovaloper1krjc2zs8uyzfdxm0cj2z428hm3ju2nfn2q9ss6',
          }
        )
        .then(res => {
          console.log(res);
    ...
    test('query a validator', async () => {
      await BaseTest.getClient()
        .staking.queryValidator('kynnovaloper1krjc2zs8uyzfdxm0cj2z428hm3ju2nfn2q9ss6')
        .then(res => {
          console.log(res);
        })
        .catch(error => {
