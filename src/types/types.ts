...
export enum TxType {
  ...
  //nft
  MsgIssueDenom ="kynno.nft.MsgIssueDenom",
  MsgTransferNFT ="kynno.nft.MsgTransferNFT",
  MsgEditNFT ="kynno.nft.MsgEditNFT",
  MsgMintNFT ="kynno.nft.MsgMintNFT",
  MsgBurnNFT ="kynno.nft.MsgBurnNFT",
  MsgIssueToken = 'kynno.token.MsgIssueToken',
  MsgEditToken = 'kynno.token.MsgEditToken',
  MsgMintToken = 'kynno.token.MsgMintToken',
  MsgTransferTokenOwner = 'kynno.token.MsgTransferTokenOwner',
  //gov
