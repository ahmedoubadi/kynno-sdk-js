...
export namespace kynno.erc20.v1 {
    ...
    export abstract class UnimplementedMsgService {
        static definition = {
            ConvertCoin: {
                ...
                requestSerialize: (message: MsgConvertCoin) => Buffer.from(message.serialize()),
                requestDeserialize: (bytes: Buffer) => MsgConvertCoin.deserialize(new Uint8Array(bytes)),
                responseSerialize: (message: MsgConvertCoinResponse) => Buffer.from(message.serialize()),
                responseDeserialize: (bytes: Buffer) => MsgConvertCoinResponse.deserialize(new Uint8Array(bytes))
            },
            ConvertERC20: {
                path: "/kynno.erc20.v1.Msg/ConvertERC20",
                requestStream: false,
                responseStream: false,
                requestSerialize: (message: MsgConvertERC20) => Buffer.from(message.serialize()),
                requestDeserialize: (bytes: Buffer) => MsgConvertERC20.deserialize(new Uint8Array(bytes)),
                responseSerialize: (message: MsgConvertERC20Response) => Buffer.from(message.serialize()),
                responseDeserialize: (bytes: Buffer) => MsgConvertERC20Response.deserialize(new Uint8Array(bytes))
            }
        };
    ...
    export class MsgClient extends grpc_1.makeGenericClientConstructor(UnimplementedMsgService.definition, "Msg", {}) {
        ...
        ConvertCoin: GrpcUnaryServiceInterface<MsgConvertCoin, MsgConvertCoinResponse> = (message: MsgConvertCoin, metadata: grpc_1.Metadata | grpc_1.CallOptions | grpc_1.requestCallback<MsgConvertCoinResponse>, options?: grpc_1.CallOptions | grpc_1.requestCallback<MsgConvertCoinResponse>, callback?: grpc_1.requestCallback<MsgConvertCoinResponse>): grpc_1.ClientUnaryCall => {
            return super.ConvertCoin(message, metadata, options, callback);
        };
        ConvertERC20: GrpcUnaryServiceInterface<MsgConvertERC20, MsgConvertERC20Response> = (message: MsgConvertERC20, metadata: grpc_1.Metadata | grpc_1.CallOptions | grpc_1.requestCallback<MsgConvertERC20Response>, options?: grpc_1.CallOptions | grpc_1.requestCallback<MsgConvertERC20Response>, callback?: grpc_1.requestCallback<MsgConvertERC20Response>): grpc_1.ClientUnaryCall => {
