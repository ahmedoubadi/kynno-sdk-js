...
export namespace kynno.vesting.v1 {
    ...
    export abstract class UnimplementedMsgService {
        static definition = {
            CreateClawbackVestingAccount: {
                ...
                requestSerialize: (message: MsgCreateClawbackVestingAccount) => Buffer.from(message.serialize()),
                requestDeserialize: (bytes: Buffer) => MsgCreateClawbackVestingAccount.deserialize(new Uint8Array(bytes)),
                responseSerialize: (message: MsgCreateClawbackVestingAccountResponse) => Buffer.from(message.serialize()),
                responseDeserialize: (bytes: Buffer) => MsgCreateClawbackVestingAccountResponse.deserialize(new Uint8Array(bytes))
            },
            Clawback: {
                path: "/kynno.vesting.v1.Msg/Clawback",
                requestStream: false,
                responseStream: false,
                requestSerialize: (message: MsgClawback) => Buffer.from(message.serialize()),
                requestDeserialize: (bytes: Buffer) => MsgClawback.deserialize(new Uint8Array(bytes)),
                responseSerialize: (message: MsgClawbackResponse) => Buffer.from(message.serialize()),
                responseDeserialize: (bytes: Buffer) => MsgClawbackResponse.deserialize(new Uint8Array(bytes))
            }
        };
    ...
    export class MsgClient extends grpc_1.makeGenericClientConstructor(UnimplementedMsgService.definition, "Msg", {}) {
        ...
        CreateClawbackVestingAccount: GrpcUnaryServiceInterface<MsgCreateClawbackVestingAccount, MsgCreateClawbackVestingAccountResponse> = (message: MsgCreateClawbackVestingAccount, metadata: grpc_1.Metadata | grpc_1.CallOptions | grpc_1.requestCallback<MsgCreateClawbackVestingAccountResponse>, options?: grpc_1.CallOptions | grpc_1.requestCallback<MsgCreateClawbackVestingAccountResponse>, callback?: grpc_1.requestCallback<MsgCreateClawbackVestingAccountResponse>): grpc_1.ClientUnaryCall => {
            return super.CreateClawbackVestingAccount(message, metadata, options, callback);
        };
        Clawback: GrpcUnaryServiceInterface<MsgClawback, MsgClawbackResponse> = (message: MsgClawback, metadata: grpc_1.Metadata | grpc_1.CallOptions | grpc_1.requestCallback<MsgClawbackResponse>, options?: grpc_1.CallOptions | grpc_1.requestCallback<MsgClawbackResponse>, callback?: grpc_1.requestCallback<MsgClawbackResponse>): grpc_1.ClientUnaryCall => {
            return super.Clawback(message, metadata, options, callback);
        };
    }
}
