...
var dependency_3 = _interopRequireWildcard(require("./auth"));
      ...
      var GenesisState = /*#__PURE__*/function (_pb_1$Message) {
        ...
        (0, _createClass2["default"])(GenesisState, [{
          ...
          value: function serialize(w) {
            ...
            if (this.accounts !== undefined) writer.writeRepeatedMessage(2, this.accounts, function (item) {
              ...
              switch (reader.getFieldNumber()) {
                case 1:
                  reader.readMessage(message.params, function () {
                    return message.params = dependency_3.cosmos.auth.v1beta1.Params.deserialize(reader);
                  });
                  break;

                case 2:
                  reader.readMessage(message.accounts, function () {
                    return pb_1.Message.addToRepeatedWrapperField(message, 2, dependency_1.google.protobuf.Any.deserialize(reader), dependency_1.google.protobuf.Any);
                  });
                  break;
