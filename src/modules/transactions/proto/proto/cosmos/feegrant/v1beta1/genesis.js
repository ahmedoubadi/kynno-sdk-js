...
var dependency_2 = _interopRequireWildcard(require("./feegrant"));
        ...
        function GenesisState(data) {
          ...
          if (!Array.isArray(data) && (0, _typeof2["default"])(data) == "object") {
            if ("allowances" in data && data.allowances != undefined) {
              _this.allowances = data.allowances;
            }
          }
          ...
          value: function fromObject(data) {
            ...
            if (data.allowances != null) {
              message.allowances = data.allowances.map(function (item) {
                return dependency_2.cosmos.feegrant.v1beta1.Grant.fromObject(item);
              });
            }
              ...
              switch (reader.getFieldNumber()) {
                case 1:
                  reader.readMessage(message.allowances, function () {
                    return pb_1.Message.addToRepeatedWrapperField(message, 1, dependency_2.cosmos.feegrant.v1beta1.Grant.deserialize(reader), dependency_2.cosmos.feegrant.v1beta1.Grant);
                  });
                  break;
