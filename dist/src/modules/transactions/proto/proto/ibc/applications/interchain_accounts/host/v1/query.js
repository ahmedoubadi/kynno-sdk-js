...
var dependency_2 = _interopRequireWildcard(require("./host"));
                  ...
                  switch (reader.getFieldNumber()) {
                    case 1:
                      reader.readMessage(message.params, function () {
                        return message.params = dependency_2.ibc.applications.interchain_accounts.host.v1.Params.deserialize(reader);
                      });
                      break;
