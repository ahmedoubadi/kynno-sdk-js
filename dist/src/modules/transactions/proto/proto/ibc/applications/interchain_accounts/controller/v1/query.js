...
var dependency_1 = _interopRequireWildcard(require("./controller"));
                  ...
                  switch (reader.getFieldNumber()) {
                    case 1:
                      reader.readMessage(message.params, function () {
                        return message.params = dependency_1.ibc.applications.interchain_accounts.controller.v1.Params.deserialize(reader);
                      });
                      break;
