...
var dependency_1 = _interopRequireWildcard(require("./../../../google/protobuf/timestamp"));
    ...
    (function (_v1beta) {
      var GenesisState = /*#__PURE__*/function (_pb_1$Message) {
        ...
        function GenesisState(data) {
          ...
          if (!Array.isArray(data) && (0, _typeof2["default"])(data) == "object") {
            if ("authorization" in data && data.authorization != undefined) {
              _this.authorization = data.authorization;
            }
          }
        ...
        (0, _createClass2["default"])(GenesisState, [{
          key: "authorization",
          get: function get() {
            return pb_1.Message.getRepeatedWrapperField(this, GrantAuthorization, 1);
          },
          ...
          value: function (_toObject) {
            ...
            if (this.authorization != null) {
              data.authorization = this.authorization.map(function (item) {
          ...
          value: function serialize(w) {
            ...
            if (this.authorization !== undefined) writer.writeRepeatedMessage(1, this.authorization, function (item) {
          ...
          value: function fromObject(data) {
            ...
            if (data.authorization != null) {
              message.authorization = data.authorization.map(function (item) {
                return GrantAuthorization.fromObject(item);
              });
            }
              ...
              switch (reader.getFieldNumber()) {
                case 1:
                  reader.readMessage(message.authorization, function () {
                    return pb_1.Message.addToRepeatedWrapperField(message, 1, GrantAuthorization.deserialize(reader), GrantAuthorization);
                  });
                  break;
      ...
      var GrantAuthorization = /*#__PURE__*/function (_pb_1$Message2) {
        (0, _inherits2["default"])(GrantAuthorization, _pb_1$Message2);

        var _super2 = _createSuper(GrantAuthorization);
          ...
          value: function deserialize(bytes) {
            ...
            while (reader.nextField()) {
              ...
              switch (reader.getFieldNumber()) {
                ...
                case 3:
                  reader.readMessage(message.authorization, function () {
                    return message.authorization = dependency_2.google.protobuf.Any.deserialize(reader);
                  });
                  break;

                case 4:
                  reader.readMessage(message.expiration, function () {
                    return message.expiration = dependency_1.google.protobuf.Timestamp.deserialize(reader);
                  });
                  break;
