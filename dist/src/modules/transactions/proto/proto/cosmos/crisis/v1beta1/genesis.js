      ...
      var GenesisState = /*#__PURE__*/function (_pb_1$Message) {
        ...
        function GenesisState(data) {
          ...
          if (!Array.isArray(data) && (0, _typeof2["default"])(data) == "object") {
            if ("constant_fee" in data && data.constant_fee != undefined) {
              _this.constant_fee = data.constant_fee;
            }
          }
        ...
        (0, _createClass2["default"])(GenesisState, [{
          ...
          value: function serialize(w) {
            ...
            if (this.constant_fee !== undefined) writer.writeMessage(3, this.constant_fee, function () {
              return _this2.constant_fee.serialize(writer);
            });
          ...
          value: function deserialize(bytes) {
            ...
            while (reader.nextField()) {
              ...
              switch (reader.getFieldNumber()) {
                case 3:
                  reader.readMessage(message.constant_fee, function () {
                    return message.constant_fee = dependency_2.cosmos.base.v1beta1.Coin.deserialize(reader);
                  });
                  break;
