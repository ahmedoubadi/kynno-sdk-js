...
var dependency_2 = _interopRequireWildcard(require("./mint"));
      ...
      var GenesisState = /*#__PURE__*/function (_pb_1$Message) {
        ...
        (0, _createClass2["default"])(GenesisState, [{
          ...
          value: function serialize(w) {
            ...
            if (this.minter !== undefined) writer.writeMessage(1, this.minter, function () {
              return _this2.minter.serialize(writer);
            });
          ...
          value: function deserialize(bytes) {
            ...
            while (reader.nextField()) {
              ...
              switch (reader.getFieldNumber()) {
                case 1:
                  reader.readMessage(message.minter, function () {
                    return message.minter = dependency_2.cosmos.mint.v1beta1.Minter.deserialize(reader);
                  });
                  break;

                case 2:
                  reader.readMessage(message.params, function () {
                    return message.params = dependency_2.cosmos.mint.v1beta1.Params.deserialize(reader);
                  });
                  break;
