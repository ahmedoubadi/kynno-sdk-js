...
var dependency_1 = _interopRequireWildcard(require("./fees"));
    ...
    (function (_v) {
      var GenesisState = /*#__PURE__*/function (_pb_1$Message) {
        ...
        function GenesisState(data) {
          ...
          if (!Array.isArray(data) && (0, _typeof2["default"])(data) == "object") {
            ...
            if ("dev_fee_infos" in data && data.dev_fee_infos != undefined) {
              _this.dev_fee_infos = data.dev_fee_infos;
            }
          }
        ...
        (0, _createClass2["default"])(GenesisState, [{
          ...
          key: "dev_fee_infos",
          get: function get() {
            return pb_1.Message.getRepeatedWrapperField(this, dependency_1.kynno.fees.v1.DevFeeInfo, 2);
          },
          set: function set(value) {
          ...
          value: function (_toObject) {
            ...
            if (this.dev_fee_infos != null) {
              data.dev_fee_infos = this.dev_fee_infos.map(function (item) {
          ...
          value: function serialize(w) {
            ...
            if (this.dev_fee_infos !== undefined) writer.writeRepeatedMessage(2, this.dev_fee_infos, function (item) {
          ...
          value: function fromObject(data) {
            ...
            if (data.dev_fee_infos != null) {
              message.dev_fee_infos = data.dev_fee_infos.map(function (item) {
                return dependency_1.kynno.fees.v1.DevFeeInfo.fromObject(item);
              });
            }
          ...
          value: function deserialize(bytes) {
            ...
            while (reader.nextField()) {
              ...
              switch (reader.getFieldNumber()) {
                ...
                case 2:
                  reader.readMessage(message.dev_fee_infos, function () {
                    return pb_1.Message.addToRepeatedWrapperField(message, 2, dependency_1.kynno.fees.v1.DevFeeInfo.deserialize(reader), dependency_1.kynno.fees.v1.DevFeeInfo);
                  });
                  break;
      ...
      var Params = /*#__PURE__*/function (_pb_1$Message2) {
        ...
        function Params(data) {
          ...
          if (!Array.isArray(data) && (0, _typeof2["default"])(data) == "object") {
            if ("enable_fees" in data && data.enable_fees != undefined) {
              _this3.enable_fees = data.enable_fees;
            }
            ...
            if ("validator_shares" in data && data.validator_shares != undefined) {
              _this3.validator_shares = data.validator_shares;
            }
        ...
        (0, _createClass2["default"])(Params, [{
          ...
          value: function serialize(w) {
            var writer = w || new pb_1.BinaryWriter();
            if (this.enable_fees !== undefined) writer.writeBool(1, this.enable_fees);
            if (typeof this.developer_shares === "string" && this.developer_shares.length) writer.writeString(2, this.developer_shares);
            if (typeof this.validator_shares === "string" && this.validator_shares.length) writer.writeString(3, this.validator_shares);
            if (this.addr_derivation_cost_create !== undefined) writer.writeUint64(4, this.addr_derivation_cost_create);
            if (!w) return writer.getResultBuffer();
          }
        }, {
          key: "serializeBinary",
