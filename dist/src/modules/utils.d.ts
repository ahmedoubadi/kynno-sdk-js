...
export declare class Utils {
    ...
    toCosmos(address: string): any;
    toOsmosis(address: string): any;
    /**
     ...
     */
    solidityPack(types: string[], values: any[]): Buffer;
    /**
   ...
   */
     ...
     */
    legacyToBuffer(value: ToBufferInputTypes): Buffer;
    /**
     ...
     */
    numberToBuffer(num: number): Buffer;
}
