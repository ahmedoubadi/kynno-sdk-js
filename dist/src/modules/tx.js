  ...
  (0, _createClass2["default"])(Tx, [{
    ...
    value: function () {
      var _sign = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee2(stdTx, baseTx) {
        var _account$base_account, _account$base_account2, _parseInt2;
        ...
        return _regenerator["default"].wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 13:
                wallet = new _ethers.ethers.Wallet(privKey, this.client.config.provider);
                _context2.next = 16;
              ...
              case 20:
                ...
                accountNumber = (_account$base_account = account.base_account.account_number) !== null && _account$base_account !== void 0 ? _account$base_account : 0;
                sequence = (_account$base_account2 = account.base_account.sequence) !== null && _account$base_account2 !== void 0 ? _account$base_account2 : 0;

                if (!stdTx.hasPubKey()) {
                  pubKey = _utils.Crypto.getPublicKeyFromPrivateKey(privKey, baseTx.pubkeyType);
                  stdTx.setPubKey(pubKey, (_parseInt = parseInt(sequence)) !== null && _parseInt !== void 0 ? _parseInt : undefined);
                }

                signature = _utils.Crypto.generateSignature(stdTx.getSignDoc((_parseInt2 = parseInt(accountNumber)) !== null && _parseInt2 !== void 0 ? _parseInt2 : undefined, baseTx.chainId || this.client.config.chainId).serializeBinary(), privKey, baseTx.pubkeyType);
